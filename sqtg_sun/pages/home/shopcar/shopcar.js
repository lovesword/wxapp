...
Page({
    ...
    addPlat: function(t) {
        var a = this, e = a.data.cart, c = a.data.cartCount, n = t.currentTarget.dataset.index, r = t.currentTarget.dataset.id, s = e[n].num + 1;
        e[n].num = s, a.changeNum(r, s).then(function() {
            a.setData({
                cart: e,
                cartCount: c + 1
            });
    ...
    reducePlat: function(t) {
        var a = this, e = a.data.cart, c = a.data.cartCount, n = t.currentTarget.dataset.index, r = t.currentTarget.dataset.id;
        if (1 < e[n].num) {
            var s = e[n].num - 1;
            e[n].num = s, a.changeNum(r, s).then(function() {
                a.setData({
    ...
    toOrder: function(t) {
        var a = this, c = a.data.cart, e = [], n = [];
        c.forEach(function(t, a) {
            t.status && (e.push(t), n.push(t.id));
        }), e.length ? app.ajax({
