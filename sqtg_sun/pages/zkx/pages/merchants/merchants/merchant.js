...
var app = getApp(),
    foot = require("../../../../../../zhy/component/comFooter/dealfoot.js");
Page({
    data: {
        hotSearch: !1,
        hadsearch: [],
    ...
    onLoad: function(t) {
        var a = this,
            e = (a.data.value, wx.getStorageSync("userInfo"));
        e.id ? a.setData({
            user_id: e.id
        }) : wx.showModal({
            title: "提示",
    ...
    _onNavTab1: function(t) {
        var a = getCurrentPages(),
            e = "/" + a[a.length - 1].route,
            s = t.currentTarget.dataset.index,
            r = this.data.banner[s].link,
            i = this.data.banner[s].typeid;
