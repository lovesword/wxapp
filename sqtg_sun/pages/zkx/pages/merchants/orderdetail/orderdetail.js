...
Page({
    ...
    confirmOrder: function(a) {
        var t = this,
            e = (a.currentTarget.dataset.id, t.data.goods);
        app.ajax({
        ...
        wx.showModal({
            ...
            success: function(a) {
                a.confirm && app.ajax({
                    ...
                    success: function(a) {
                        e.order_status = 5, e.refund = {}, e.refund.review_status = 0, e.refund.refund_status = 0, wx.showToast({
                            title: "申请退款成功"
                        }), t.setData({
                            goods: e
                        })
