...
Page({
    ...
    formSubmit: function(a) {
        var t = this,
            e = a.detail.value.tel,
            s = a.detail.value.uname,
            n = "",
            o = !1,
            i = t.data.money || 0,
            d = t.data.plat,
            r = t.data.store;
        i > parseFloat(r.money) || i < parseFloat(d.min_money) ? n = "金额不得大于" + r.money + "元或小于" + d.min_money + "元" : "" == s || null == s ? n = "请输入您的姓名" : /^1(3|4|5|7|8|9)\d{9}$/.test(e) ? (o = !0, t.setData({
            sending: !0
        }), setTimeout(function() {
            t.setData({
                sending: !1
