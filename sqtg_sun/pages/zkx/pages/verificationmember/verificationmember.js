...
Page({
    ...
    deleteMember: function(a) {
        var t = this,
            e = a.currentTarget.dataset.leaderuserid;
        t.setData({
            status: !0
        }), app.ajax({
    ...
    addMember: function(a) {
        var t = this,
            e = a.currentTarget.dataset.memid;
        t.setData({
            status: !0
        }), app.ajax({
            url: "Cleader|addUser",
    ...
    searchBtn: function(a) {
        ...
        "" != (e = e.trim()) && (app.ajax({
            ...
            success: function(a) {
                if (console.log(a), 0 == a.data.length) return app.tips("查无此人"), t.setData({
                    olist: []
                }), !1;
                t.setData({
                    olist: a.data
